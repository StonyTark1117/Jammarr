...
- The matching Jammarr Minecraft-version and loader artifact on the dedicated server, plus on each client that should receive Jammarr functionality. The client-only 1.8.9 LiteLoader companion is paired with a 1.8.9 Forge server artifact.
...
| 1.7.10 | 8 | unavailable | unavailable | unavailable | supported | unavailable | unavailable | unavailable |
