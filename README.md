...
| Minecraft | Java | Fabric | Quilt | Forge | NeoForge | Ornithe |
| --- | ---: | :---: | :---: | :---: | :---: | :---: |
| 1.6.4 | 8 | preview (Legacy Fabric) | unavailable | preview | unavailable | preview |
| 1.7.10 | 8 | unavailable | unavailable | supported | unavailable | unavailable |
| 1.8.9 | 8 | preview (Legacy Fabric) | unavailable | preview | unavailable | preview |
| 1.12.2 | 8 | unavailable | unavailable | supported | unavailable | unavailable |
| 1.16.5 | 8 | supported | supported | supported | unavailable | unavailable |
| 1.18.2 | 17 | supported | supported | supported | unavailable | unavailable |
| 1.19.2 | 17 | supported | supported | supported | unavailable | unavailable |
| 1.20 | 17 | supported | supported | preview | unavailable | unavailable |
| 1.20.1 | 17 | supported | supported | supported | supported | unavailable |
| 1.20.2 | 17 | supported | supported | supported | supported | unavailable |
| 1.20.3 | 17 | supported | supported | preview | preview | unavailable |
| 1.20.4 | 17 | supported | supported | supported | supported | unavailable |
| 1.20.5 | 21 | supported | supported | unavailable | preview | unavailable |
| 1.20.6 | 21 | supported | supported | supported | supported | unavailable |
| 1.21 | 21 | supported | supported | preview | supported | unavailable |
| 1.21.1 | 21 | supported | supported | supported | supported | unavailable |
| 1.21.2 | 21 | supported | supported | unavailable | preview | unavailable |
| 1.21.3 | 21 | supported | supported | supported | supported | unavailable |
| 1.21.4 | 21 | supported | supported | supported | supported | unavailable |
| 1.21.5 | 21 | supported | supported | supported | supported | unavailable |
| 1.21.6 | 21 | supported | supported | preview | preview | unavailable |
| 1.21.7 | 21 | supported | supported | preview | preview | unavailable |
| 1.21.8 | 21 | supported | supported | supported | supported | unavailable |
| 1.21.9 | 21 | supported | supported | preview | preview | unavailable |
| 1.21.10 | 21 | supported | supported | supported | supported | unavailable |
| 1.21.11 | 21 | supported | supported | supported | supported | unavailable |
| 26.1.2 | 25 | supported | supported | supported | supported | unavailable |
| 26.2 | 25 | supported | supported | supported | supported | unavailable |

Fabric is unavailable for Minecraft 1.7.10 and 1.12.2; Minecraft 1.6.4 and 1.8.9 instead have separately pinned Legacy Fabric previews. Both 1.6.4 and 1.8.9 also have distinct Ornithe/Feather generation-2 previews that require OSL 0.21.0-alpha.36, Fabric Loader 0.19.5, Loom 1.17.20, and Ploceus 1.17.7; neither is interchangeable with the matching Legacy Fabric JAR. Quilt and NeoForge are unavailable for all four legacy Minecraft versions, neither Legacy Fabric nor Ornithe JAR is Quilt-compatible, and Ornithe is unavailable outside its explicitly listed targets. NeoForge is also unavailable before 1.20.1. Quilt is supported on each modern Fabric target that explicitly declares compatibility, using the matching `-fabric.jar`, Quilt Loader, and upstream Fabric API; no QSL, Quilted Fabric API, or separate `-quilt.jar` is required or published. Fabric-to-Quilt connections and other cross-loader or cross-Minecraft pairings are unsupported. Every 1.1.0 artifact uses protocol 6 and is named `jammarr-<mod-version>+mc<version>-<loader>.jar`; there is no cross-Minecraft or Forge-family universal JAR. Exact pinned dependencies are listed in the family catalogs under `gradle/version-catalogs/` and copied into the generated release manifest.
...
- Press `J` by default on modern Minecraft (`P` on 1.6.4, 1.7.10, and 1.8.9), or run `/jammarr` to open the music screen. The key appears as **Open Jammarr** in Controls and can be rebound on every supported version and loader. The modern default avoids vanilla's Social menu binding on `P`.
...
Useful narrower gates are `verify164Family`, `verifyForge164`, `verifyLegacyFabric164`, `verifyOrnithe164`, `verify1182Family`, `verify1192Family`, `verify1201Family`, `verify1202Family`, `verify121Family`, `verify1211Family`, `verify1212Family`, `verify2612Family`, `verify262Family`, `verifyQuiltRuntimes`, `verifyLegacy1710`, `verifyForge189`, `verifyLegacyFabric189`, `verifyOrnithe189`, and `verifyGameTests`. Each target's `verifyRelease` checks loader metadata, translations, decoder dependencies, license notices, canonical filename, and other target-specific invariants. The legacy verifiers additionally check the exact supported class format: Java 8 bytecode normally, or the Java-7 class header required for Forge 1.6.4's ASM 4 while retaining a Java 8 runtime requirement.
