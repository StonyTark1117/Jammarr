package stonytark.pampmod.config;

import net.neoforged.neoforge.common.ModConfigSpec;

public final class PampConfig {
    ...
    public static final ModConfigSpec.ConfigValue<String> PLEX_TOKEN = SERVER_BUILDER
            .comment("Plex token. Prefer the PAMPMOD_PLEX_TOKEN environment variable.")
            .define("plexToken", "");
    ...
    public static final ModConfigSpec.IntValue QUEUE_LIMIT = SERVER_BUILDER
            .comment("Maximum global queue length. PAmpMod v1 caps this at 500 tracks.")
    ...
    public static final ModConfigSpec.BooleanValue ENABLED = CLIENT_BUILDER
            .comment("Listen to the server's PAmpMod stream by default.")
            .define("enabled", true);
    public static final ModConfigSpec.DoubleValue VOLUME = CLIENT_BUILDER
            .comment("Additional PAmpMod volume multiplier.")
    ...
    public static String plexToken() {
        String environment = System.getenv("PAMPMOD_PLEX_TOKEN");
