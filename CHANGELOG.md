...
- Start decoded audio with enough of the server's scheduling lead remaining, wait for measured clock synchronization, and skip PCM elapsed during asynchronous channel creation instead of accepting several hundred milliseconds of startup skew.
