...
- Address the menu-clarity feedback from GitHub issue #2 with concise hover help for every actionable player-menu tab and control across all legacy and modern screen adapters; retain private-display visual confirmation as a final release gate.
