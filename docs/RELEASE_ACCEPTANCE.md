...
The release gate observes each real client's decoded output through an isolated audio sink; PLAYING state or an allocated OpenAL source alone is not accepted. Retain a result for every loader before publishing a Minecraft family:
