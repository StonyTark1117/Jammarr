...
/** LiteLoader lifecycle and plugin-channel adapter for Forge-backed Jammarr servers. */
public final class LiteModJammarr implements Tickable, JoinGameListener, PluginChannelListener, ChatListener {
    ...
    @Override public void init(File configPath) {
        ...
        Jammarr.LOGGER.info("Initializing Jammarr {} client companion for LiteLoader 1.8.9 protocol {}",
    ...
    @Override public void onCustomPayload(String channel, PacketBuffer data) {
        LegacyNetwork.receive(channel, data);
    }
