...
/** Legacy Fabric 1.6.4 command surface matching the modern /jammarr tree. */
...
public final class LegacyCommands extends AbstractCommand {
    ...
    private static void reply(CommandSource source, String message) {
        source.method_5505(ChatMessage.createTextMessage(message));
    }

    @Override public List method_3276(CommandSource source, String[] arguments) {
    ...
    @Override public int compareTo(Object other) {
        return getCommandName().compareTo(((net.minecraft.command.Command) other).getCommandName());
    }
