...
/** Placeholder-format logger for Minecraft versions predating Log4j. */
public final class LegacyLogger {
    ...
    public void info(String message, Object... arguments) { delegate.info(format(message, arguments)); }
    public void warn(String message, Object... arguments) { log(Level.WARNING, message, arguments); }
    public void error(String message, Object... arguments) { log(Level.SEVERE, message, arguments); }
