...
class LegacyEnvelopeTest {
    ...
    void carriesCanonicalClientHelloBytes() {
        ...
        byte[] packet = outgoing.toPacket();
        LegacyEnvelope incoming = LegacyEnvelope.fromPacket(packet);
    ...
    void rejectsWrongDirectionUnknownIdsAndTrailingBytes() {
        ...
        assertThrows(ProtocolException.class, () -> LegacyEnvelope.fromPacket(unknown));
        ...
        assertThrows(ProtocolException.class, () -> LegacyEnvelope.fromPacket(trailing));
    }
    ...
    void rejectsOversizedDeclaredPayload() {
        ...
        assertThrows(ProtocolException.class, () -> LegacyEnvelope.fromPacket(oversized));
    }
