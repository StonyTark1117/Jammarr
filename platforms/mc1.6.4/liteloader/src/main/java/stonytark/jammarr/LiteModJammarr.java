...
/** LiteLoader 1.6.4 lifecycle and plugin-channel adapter for Forge-backed Jammarr servers. */
public final class LiteModJammarr implements Tickable, PluginChannelListener, ChatListener {
    ...
    @Override public void init(File configPath) {
        ...
        Jammarr.LOGGER.info("Initializing Jammarr {} client companion for LiteLoader 1.6.4 protocol {}",
    ...
    @Override public void onLogin(NetHandler handler, Packet1Login packet) {
    ...
    @Override public void onChat(ChatMessageComponent message, String unformattedMessage) {
