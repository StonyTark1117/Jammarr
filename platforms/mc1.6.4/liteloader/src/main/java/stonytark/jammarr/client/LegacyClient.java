...
/** LiteLoader lifecycle adapter for the shared Minecraft 1.6.4 client implementation. */
public final class LegacyClient {
    private static final KeyBinding OPEN = new KeyBinding("key.jammarr.open", Keyboard.KEY_P);
    ...
    public static synchronized void register() {
        ...
        LiteLoader.getInstance().registerModKey(OPEN);
