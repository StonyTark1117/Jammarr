...
public final class JammarrClient {
    ...
    public static void register(FMLJavaModLoadingContext context) {
        ...
        RegisterKeyMappingsEvent.getBus(modBusGroup).addListener(INSTANCE::keys);
        RegisterClientReloadListenersEvent.getBus(modBusGroup).addListener(INSTANCE::reloadListeners);
