...
/** Schema-4 world state stored through Forge 1.12.2 WorldSavedData. */
public final class LegacySavedData extends WorldSavedData implements PlaybackStore {
    ...
    public static LegacySavedData get(MinecraftServer server) {
        ...
        LegacySavedData data = (LegacySavedData) storage.getOrLoadData(LegacySavedData.class, DATA_NAME);
        if (data == null) {
