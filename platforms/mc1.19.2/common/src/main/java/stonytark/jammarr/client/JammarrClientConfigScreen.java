...
public final class JammarrClientConfigScreen extends Screen {
    ...
    @Override protected void init() {
        ...
        addRenderableWidget(CompatButton.builder(Component.translatable("jammarr.config.done"), button -> onClose())
    ...
    @Override public void render(PoseStack graphics, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredString(graphics, font, Component.translatable("jammarr.config.local_only"), width / 2, height / 2 - 46, 0xA0D8FF);
    }
