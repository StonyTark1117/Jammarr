...
public final class JammarrConfig {
    ...
    public static final ForgeConfigSpec.EnumValue<RestartMode> RESTART_MODE = SERVER_BUILDER.defineEnum("restartMode", RestartMode.RESTART_TRACK);
    public static final ForgeConfigSpec.BooleanValue PAUSE_WHEN_EMPTY = SERVER_BUILDER.define("pauseWhenNoPlayers", true);
    ...
    public static final ForgeConfigSpec.IntValue BITRATE = SERVER_BUILDER.defineInRange("audioBitrateKbps", 160, 64, 320);
    public static final ForgeConfigSpec.LongValue CACHE_MIB = SERVER_BUILDER.defineInRange("cacheSizeMiB", 1024L, 64L, 16384L);
