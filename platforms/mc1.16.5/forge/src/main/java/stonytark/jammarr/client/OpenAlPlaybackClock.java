...
final class OpenAlPlaybackClock {
    ...
    static boolean alignBeforeStart(SoundSource channel, LegacyPcmAudioStream stream, long offsetMillis) {
    ...
    static Position sample(SoundSource channel, LegacyPcmAudioStream stream) {
    ...
    private static int source(SoundSource channel) {
    ...
    private static int read(Field field, SoundSource channel) {
        try {
